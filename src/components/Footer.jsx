    ...
    <footer className="py-16 px-6 bg-slate-50 dark:bg-slate-900/50">
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center gap-8">
        <motion.div
          ...
          className="space-y-4"
        >
          <a href="#home" className="text-3xl font-display font-bold text-gradient">
            MR Sanjid
          </a>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-full gap-8 pt-8 border-t border-slate-200 dark:border-slate-800">
          ...
          <div className="flex items-center gap-4">
            <span className="text-xs font-bold uppercase tracking-widest opacity-40">Back to top</span>
            <motion.button
              whileHover={{ y: -5 }}
              whileTap={{ scale: 0.9 }}
              onClick={scrollToTop}
